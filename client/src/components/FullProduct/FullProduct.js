    ...
    return (
      <div className="full-item">
        ...
        <div className="full-product-card">
          {' '}
          {/* white div */}
          <div className="close" onClick={() => this.props.onShowProduct(this.props.item)}>
            Close
          </div>
          <MiniGallery photos={this.props.item?.gallery} />
          <img src={this.props.item.gallery[0]} className="full-gallery" alt="product" />
